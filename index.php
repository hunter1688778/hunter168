...
<body>
    <nav class="navbar navbar-expand-lg bg-black mt-0 shadow-sm mb-0">
        <div class="container-sm pt-4 pb-4 ps-4 pe-4 ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mx-auto me-auto mb-2 mb-lg-3">
                    ...
                    <ul class="nav-item align-self-center">
                        <li class="nav-item dropdown" style="list-style: none;">
                            <a class="nav-link align-self-center text-main" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="assets/icon/wheel.png" width="20" class="mb-1">&nbsp;หมุนกงล้อ</a>
                            <ul class="dropdown-menu shadow-sm p-4 pt-2 pb-2" style="border-radius: 0px;" aria-labelledby="navbarDropdown">
                                <li>

                                </li>
                                <li>
                                    <a class="dropdown-item text-main mb-1" href="?page=play&wheel=5"><small><img src="assets/icon/wheel.png" width="20" class="mb-1">&nbsp;กงล้อเสี่ยงโชค</small></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <li class="nav-item align-self-center ms-lg-3">
                        <a class="nav-link underline-active align-self-center text-main" aria-current="page" href="/?page=payment"><img src="assets/icon/credit.png" width="20" class="mb-1">&nbsp;ฝากเงิน</a>
                    </li>
                    <li class="nav-item align-self-center ms-lg-3">
                        <a class="nav-link underline-active align-self-center text-main" aria-current="page" href="/?page=connect"><img src="assets/icon/dollar.png" width="20" class="mb-1">&nbsp;ถอนเงิน</a>
                    </li>
	
                        <li class="nav-item align-self-center ms-lg-3">
                            <a class="nav-link underline-active align-self-center text-main" aria-current="page"
                                href="https://lin.ee/Wy5SyDu"><img src="assets/icon/call-center.png" width="20"
                ...
                ?>
                    ...
                    <ul class="navbar-nav ms-auto  mb-2 mb-lg-0 ">
                        <li class="nav-item dropdown" style="list-style: none;">
                            ...
                            <ul class="dropdown-menu shadow-sm p-4 pt-2 pb-2" style="border-radius: 0px;" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item text-dark mb-1"><small><img src="assets/icon/dollar.png" width="20" class="mb-1">&nbsp;&nbsp;ยอดเงินคงเหลือ : <?php echo number_format($user["point"]); ?></small></a></li>
...
<li><a class="dropdown-item text-main mb-1" href="?page=history"><small><img src="assets/icon/history.png" width="20" class="mb-1">&nbsp;&nbsp;ประวัติทั้งหมด</small></a></li>
                                ...
                                if ($user["rank"] == "1") {
                                ?>
                                    <li><a class="dropdown-item text-main mb-1" href="?page=backend"><small><img src="assets/icon/manager.png" width="20" class="mb-1">&nbsp;จัดการหลังบ้าน</small></a></li>
                                <?php
                                }
                                ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-3 pb-2">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="shop-btn" class="btn w-100"
                         style="background-color: var(--main); color: #fff;" onclick="buybox()" data-id="" data-name="" data-price=""><i class="text-black fa-duotone fa-cart-shopping-fast"></i>&nbsp;&nbsp;สั่งซื้้อเลย</button>
                    </div>
                </div>
            </div>
        </div>
