                ...
                <div class="container-sm p-0">
                    <div class="row justify-content-center">
                        <div class="col-lg-3">
                            <div class="container-fluid bg-glass p-4 pt-5 rounded border shadow-sm">
                                <center>
                                    ...
                                    <small class="text-white">เติมเงินผ่านซองอั่งเปา TrueWallet</small>
                        ...
                        <div class="col-lg-3">
                            <div class="container-fluid bg-glass p-4 pt-5 rounded border shadow-sm">
                                <center>
                                    <img src="assets/img/pm.png" class="img-fluid mb-3" style="height: 100px;">
                                    <h2 class="text-main mb-0">QR CODE</h2>
                                    <small class="text-white">สแกนQR CODEเพื่อเติมเงิน</small>
                                    <a href="/?page=redeem" class="btn bg-main w-100 mt-2 text-white">สแกน</a>
                                </center>
                            </div>
                        </div>
                    </div>
