<div class="container-fluid p-4">
    <div class="container-sm m-auto p-4 pt-0" data-aos="zoom-in">
        ...
        <center class="m-0"><h2 class="text-main mb-2 mt-4 p-4"><i class="fa-regular fa-history"></i> ประวัติการเล่น</h2></center>
        <hr class="mt-1">
            <div class="table-responsive">
                <table class="table table-striped " id="table">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="text-main">เกมล่าสุด</th>
                        <th scope="col" class="text-main">เงินรางวัล</th>
