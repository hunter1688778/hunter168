                ...
                <div class="container-fluid p-4  bg-glass shadow-sm">
                    <div class="d-flex mb-2">
                        ...
                        <div class="align-self-center">
                            <h2 class="text-main ms-1 mb-0"><?= $wheel['name'] ?></h2>
                            <h5 class="text-white ms-1">เล่นวงล้อนำโชค </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 m-auto">
                        <div class="row text-white">
                            ...
                            <center>
                                <a class="btn bg-main w-100 text-white mb-2" id="random" style="border-radius: 40px;">เริ่มสุ่มรางวัล (<?php echo number_format($wheel["price"], 2)?>บาท)</a>
                            </center>
                        </div>
                    </div>
                </div>
